$(document).ready(function() {
    function n(e) {
        ...
        }), $(".active-page > .sub-menu").length && o.click()
    }(), $("body").hasClass("header-fixed") && ($(window).scroll(function() {
            20 < $(this).scrollTop() ? $(".lime-header").addClass("scroll-header") : $(".lime-header").removeClass("scroll-header")
        }), $(window).on("load", function() {
            0 < $(this).scrollTop() ? $(".lime-header").addClass("scroll-header") : $(".lime-header").removeClass("scroll-header")
        })), $(window).click(function() {
        ...
        function() {
            ...
            Array.prototype.filter.call(e, function(o) {
                o.addEventListener("submit", function(e) {
                    !1 === o.checkValidity() && (e.preventDefault(), e.stopPropagation()), o.classList.add("was-validated")
                }, !1)
            })
        }, !1)
});